...
export const DesktopHero = () => {
  return (
    <div className="w-full relative flex flex-col items-center pt-[160px] pb-8 overflow-hidden bg-[#fffff0]">
      ...
      {/* Hero Text */}
      <div className="flex flex-col items-center text-center z-10 max-w-[1000px] mx-auto px-6">
      ...
      <div className="w-full px-8 md:px-12 mt-20 flex items-end justify-between z-10">
        {/* Left side text */}
